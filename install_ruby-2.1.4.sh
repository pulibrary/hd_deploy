...
[[ -e "/opt/install/ruby-2.1.4.tar.gz" && `md5sum /opt/install/ruby-2.1.4.tar.gz` == "9227787a9636551f1749ee8394b5ffe5"* ]] || wget -c http://cache.ruby-lang.org/pub/ruby/2.1/ruby-2.1.4.tar.gz
