...
#if $APP_NAME doesn't exist solr-4.10.2
#then
#abort
#else
#continue
...
wget -c http://archive.apache.org/dist/lucene/solr/4.10.2/solr-4.10.2.tgz
...
cp ./solr-4.10.2/dist/solr-4.10.2.war /opt/solr/$APP_NAME
cp ./solr-4.10.2/dist/*.jar /opt/solr/$APP_NAME/lib
cp -r ./solr-4.10.2/contrib /opt/solr/$APP_NAME/lib
cp -r ./solr-4.10.2/example/solr/collection1 /opt/solr/$APP_NAME/collection1
cp /opt/solr/$APP_NAME/collection1/conf/lang/stopwords_en.txt /opt/solr/$APP_NAME/collection1/conf/
# for v 4.3 
cp ./solr-4.10.2/example/lib/ext/*.jar /usr/share/tomcat7/lib/ 
cp ./solr-4.10.2/example/scripts/cloud-scripts/log4j.properties /usr/share/tomcat7/lib/

# create the project xml file
cat > /opt/solr/$APP_NAME/$APP_NAME.xml <<EOF
<?xml version="1.0" encoding="utf-8"?>  
<Context docBase="/opt/solr/$APP_NAME/solr-4.10.2.war" debug="0" crossContext="true">  
